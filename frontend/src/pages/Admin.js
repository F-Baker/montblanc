...
import {Avatar, Button, CssBaseline, Grid, Paper, Typography, withStyles, TextField, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Select, FormControl, MenuItem} from "@material-ui/core";
                ...
                <Dialog open={this.state.dialogOpen} onClose={this.handleDialogClose} aria-labelledby="form-dialog-title">
                    ...
                    <DialogContent>
                        ...
                        <FormControl className={classes.formControl}>
                            ...
                            >
                                {this.state.statusList.map((status)=>(<MenuItem id={status.enrollmentStatusId} value={status.enrollmentStatusId}>{status.name}</MenuItem>))}
                            </Select>
                        </FormControl>
                    </DialogContent>
                    <DialogActions>
